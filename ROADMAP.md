...
- [ ] **Normalise tags to lower case** — tasting notes and other tags should be consistently lowercased
- [ ] **Similar coffees less prominent** — reduce visual weight of similar coffees section on coffee detail page
- [ ] **Similarity reasons** — replace percentage match with human-readable explanation ("similar flavours", "from a similar region", etc.)
...
- [ ] **Small Batch image extraction** — write a custom scraper to fetch product images from smallbatch.com.au
