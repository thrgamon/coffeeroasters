                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.MagicLinkRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.MagicLinkResponse"
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.VerifyMagicLinkRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.CoffeeDetailResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.CountryListResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.CountryDetailResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.ProducerDetailResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.RegionDetailResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.RoasterListResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.RoasterDetailResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
    ...
    "definitions": {
        ...
        "domain.CountryDetailResponse": {
            ...
            "properties": {
                ...
                "regions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.RegionSummary"
                    }
                }
            }
        },
        "domain.CountryListResponse": {
            "type": "object",
            "properties": {
                "countries": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.CountryResponse"
                    }
                }
            }
        },
        ...
        "domain.RegionDetailResponse": {
            ...
            "properties": {
                ...
                "nearby_regions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.NearbyRegion"
                    }
                }
            }
        },
        "domain.RegionSummary": {
            "type": "object",
            "properties": {
                "coffee_count": {
                    "type": "integer"
        ...
        "domain.RoasterDetailResponse": {
            ...
            "properties": {
                ...
                "roaster": {
                    "$ref": "#/definitions/domain.RoasterResponse"
                }
            }
        },
        "domain.RoasterListResponse": {
            "type": "object",
            "properties": {
                "roasters": {
                    "type": "array",
